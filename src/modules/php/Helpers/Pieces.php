...
class Pieces extends DB_Manager
{
    ...
    public static function getState($id)
    {
        ...
        return is_null($res)
            ? null
            : $res[(static::$autoremovePrefix ? '' : static::$prefix) . 'state'];
    }
    ...
    public static function getLocation($id)
    {
        ...
        return is_null($res)
            ? null
            : $res[(static::$autoremovePrefix ? '' : static::$prefix) . 'location'];
    }
    ...
    public static function getInLocationPId(
        $location,
        $pId,
        $state = null,
        $orderBy = null
    ) {
        return self::getInLocationQ($location, $state, $orderBy)
            ->where('player_id', $pId)
            ->get();
    }
